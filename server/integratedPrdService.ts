...
export class IntegratedPrdService {
  ...
  public modifyHotelStay(
    ...
    if (modifications.hotel_name) {
      hotel.hotel_name = modifications.hotel_name;
    }
    if (modifications.address) {
      hotel.address = modifications.address;
    }
    if (modifications.city) {
      hotel.city = modifications.city;
    }
    if (modifications.contact_phone) {
      hotel.contact_phone = modifications.contact_phone;
    }
    if (modifications.room_type) {
      hotel.room_type = modifications.room_type;
    }
    if (modifications.confirmation_code) {
      hotel.confirmation_code = modifications.confirmation_code;
    }
