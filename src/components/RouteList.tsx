      ...
      <div className="grid grid-cols-1 gap-4">
        {routes.length === 0 ? (
          <div className="p-10 text-center bg-white rounded-2xl border border-slate-200 text-slate-500">
            ...
            <p className="font-semibold text-slate-700">Enter origin and destination to search routes</p>
            <p className="text-xs text-slate-400 mt-1">Search any city, airport, station, or pick on map</p>
          </div>
        ) : (
          routes.map((route) => {
