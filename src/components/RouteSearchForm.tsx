        ...
        <div className="mb-4 px-3.5 py-2.5 rounded-xl bg-slate-50/70 border border-slate-200/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5">
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1 -ml-1 text-blue-600 hover:text-blue-700 rounded-md hover:bg-blue-50 transition-colors cursor-pointer group flex items-center justify-center"
            >
              <MapPin className="w-4 h-4 text-blue-600 group-hover:scale-110 transition-transform shrink-0" />
            </button>
          ...
          <div className="w-full sm:w-80">
            <input
              ...
              type="text"
              placeholder="Search or select an intermediate station"
              value={viaStation}
